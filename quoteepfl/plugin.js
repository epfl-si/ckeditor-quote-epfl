    ...
    CKEDITOR.plugins.add('quoteepfl', {
        ...
        init: function (editor) {
            ...
            editor.widgets.add('quoteepfl', {
                ...
                template: '<blockquote class="blockquote"><p>'+editor.lang.quoteepfl.putCitationHere+'</p><footer class="blockquote-footer">'+editor.lang.quoteepfl.putAuthor+'</footer></blockquote>',
                editables: {
                    quote: {
                        selector: 'p',
                    },
        ...
        onLoad: function () {
            CKEDITOR.addCss(
                'blockquote.blockquote {line-height: 1.5rem;margin: 0 0 1.5rem;text-align: center;border: 0.0625rem solid #ddd;border-radius: 0.5rem;}' +
